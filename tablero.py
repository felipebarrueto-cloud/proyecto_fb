...
def mostrar_tablero():
    ...
    st.markdown("""
        <style>
            div.stButton > button { background-color: #ff4b4b !important; color: white !important; font-weight: bold; border-radius: 10px; height: 3em; margin-top: 10px; }
    ...
    if st.button("🎴 REVELAR SIGUIENTE CARTA", use_container_width=True):
        ...
        # PASO B: PROCESAR ARCHIVO (Vaciado inmediato a Mesa o Descarte)
        ...
        # PASO C: Mover la carta activa anterior a la mesa
        ...
        # PASO D: Revelar nueva carta del mazo
        if st.session_state.mazo:
            ...
            # Lógica de Presa para generar Æmbar si no hay amenazas activas ni en mesa
    ...
    if st.session_state.carta_activa:
        ...
        # La carta recién revelada no suma su poder individual (está agotada)
