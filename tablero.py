...
def mostrar_tablero():
    ...
    st.markdown(f"""
        <table class="compact-table">
            <tr>
                <td style="width: 30%;"><span class="label">💥 PODER TOTAL</span><span class="val-white">{poder_total}</span></td>
                <td style="width: 40%;"><span class="label">💎 RECURSOS Y MAREA</span>
                    <span class="val-white" style="font-size:16px;">{st.session_state.recursos_jefe} Æ | 🌊 {st.session_state.marea}</span>
                    <br><span style="font-size:10px; color:#888;">Avances: <b>{st.session_state.avances_jefe}/4</b></span></td>
