...
def mostrar_tablero():
    ...
    # --- CSS: TODOS LOS BOTONES GRISES Y TEXTO SOBRE NÚMERO ---
    st.markdown("""
        <style>
            /* 1. RESET TOTAL: Todos los botones color GRIS TABLA */
            div.stButton > button {
            ...
            /* 2. TABLA RESUMEN: Títulos arriba, Números abajo */
    ...
    if st.button("🎴 REVELAR SIGUIENTE CARTA", use_container_width=True):
        ...
        # Mover activa a mesa y revelar nueva
    ...
    # --- 2. TABLA RESUMEN (Títulos sobre números) ---
